    ...
    return (
        <section className="feature-details-section">
            <div className="feature-details-content">
                ...
                {/* Row 1: Titles & Naming (Visual Left, Text Right) */}
                <div className="feature-row">
                    <div className="feature-visual">
                        <div className="visual-card titles-card">
                ...
                {/* Row 2: Calendar Assignment (Text Left, Visual Right) */}
                <div className="feature-row">
                    <div className="feature-text">
                ...
                {/* Row 3: Time & Duration (Visual Left, Text Right) */}
                <div className="feature-row">
                    <div className="feature-visual">
                        <div className="visual-card duration-card">
